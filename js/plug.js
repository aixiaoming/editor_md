...
;(function(factory) {
  ...
  editormd.toolbarHandlers = {
    ...
    qiniu : function() {
      this.executePlugin("imageDialogQiniu", "image-dialog-qiniu/image-dialog-qiniu");
    },
    video : function() {
  ...
  editormd.markedRenderer = function(markdownToC, options) {
    ...
    markedRenderer.atLink = function(text) {
      ...
      const imgAlt = /<img.*?(src=".*").*(alt="\d*\*\d*")/gi
      const altGre = /alt="(\d*)\*\d*"/gi
      if (imgAlt.test(text)) {
        return text.replace(altGre, (a, b, c)=> {
          return `${a} style="max-width:${Number(b) / 2}px"`
        })
      }
      return text;
    };
